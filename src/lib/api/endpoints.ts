...
export const ENDPOINTS = {
  ...
  PRODUCT: {
    ...
    CREATE: (companyId: string) => `${API_PREFIX}/user/${companyId}/product/create`,
  ...
  COLUMN: {
    ...
    UPDATE: (companyId: string, productId: string, templateId: string, columnId: string) =>
      `${API_PREFIX}/user/${companyId}/product/${productId}/template/${templateId}/column/update/${columnId}`,
    DELETE: (companyId: string, productId: string, templateId: string, columnId: string) =>
  ...
  ROW: {
    ...
    UPDATE: (companyId: string, productId: string, templateId: string, rowId: string) =>
      `${API_PREFIX}/user/${companyId}/product/${productId}/template/${templateId}/row/update/${rowId}`,
    DELETE: (companyId: string, productId: string, templateId: string, rowId: string) =>
  ...
  EXTRA: {
    ...
    UPDATE: (companyId: string, productId: string, templateId: string, extraId: string) =>
      `${API_PREFIX}/user/${companyId}/product/${productId}/template/${templateId}/extra/update/${extraId}`,
    DELETE: (companyId: string, productId: string, templateId: string, extraId: string) =>
  ...
  ORDER: {
    ...
    LIST: (companyId: string) =>
      `${API_PREFIX}/user/${companyId}/order/list`,
  ...
  CUSTOMER: {
    LIST: (companyId: string) => `${API_PREFIX}/user/${companyId}/customer/list`,
    GET: (companyId: string, customerId: string) =>
      `${API_PREFIX}/user/${companyId}/customer/get/${customerId}`,
    CREATE: (companyId: string) => `${API_PREFIX}/user/${companyId}/customer/create`,
...
export const QUERY_KEYS = {
  ...
  TEMPLATE_COLUMNS: (companyId: string, productId: string, templateId: string) =>
