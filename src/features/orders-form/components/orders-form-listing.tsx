...
export default function OrdersFormListing({ companyId }: OrderListingProps) {
  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      const params: OrderListParams = {
        ...
        sortBy: 'createdAt',
        sortOrder: 'DESC',
        orderType: 'JOBCARD' // Only fetch orders from orders form
      };
  ...
  const handleViewOrder = (orderId: string) => {
    router.push(`/dashboard/${companyId}/orders-form/${orderId}`);
  };

  const handleEditOrder = (orderId: string) => {
    router.push(`/dashboard/${companyId}/orders-form/${orderId}/edit`);
  };

  const handleViewHistory = (orderId: string) => {
    router.push(`/dashboard/${companyId}/orders-form/${orderId}/history`);
  };
